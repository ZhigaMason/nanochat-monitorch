...
ATTN_DROPOUT="${ATTN_DROPOUT:-0.0}"             # dropout on attention probabilities (SDPA only, not FA3/Hopper)
MLP_DROPOUT="${MLP_DROPOUT:-0.0}"               # dropout on MLP hidden activations
